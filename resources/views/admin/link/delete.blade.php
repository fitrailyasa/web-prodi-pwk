...
<button role="button" class="btn btn-sm btn-dark" data-bs-toggle="modal" data-bs-target=".formDelete{{ $link->id }}"><i
        class="fas fa-trash"></i><span class="d-none d-sm-inline">
        {{ __('Hapus') }}</span></button>

<!-- Modal -->
<div class="modal fade formDelete{{ $link->id }}" tabindex="-1" role="dialog" aria-hidden="">
