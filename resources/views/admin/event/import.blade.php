    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="modalFormLabel">{{ __('Upload event') }}</h5>
            ...
            <div class="modal-footer">
                <a class="btn btn-success" href="{{ asset('assets/template/event-template.xlsx') }}"
                    download="event-template.xlsx"><i class="fas fa-download"></i> {{ __('Download Format') }}</a>
